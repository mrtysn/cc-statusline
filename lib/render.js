...
(function (root, factory) {
  ...
  function render({ input = {}, cwd, usage = null, topic = null, git = null, home = '', columns = null, icons = true, waiting = 0, alarm = false, peer = null }) {
    ...
    if (peer) middle.push(paint(DIM, peer));
    if (topic?.text) middle.push(paint(topic.isNew ? YELLOW : '', topic.text) + (mark ? ' ' + mark : ''));
